...
group_data=Ti.App.Properties.getString('Groups','All');
...
var topView5 = Ti.UI.createView({
	backgroundColor : '#0055A6',
	width : '12%',
	height : '100%',
	right : '12.5%'
});
topView5.addEventListener('click', function() {
...
topview.add(topView5);
var topImageView5 = Ti.UI.createImageView({
	image : '/images/group_icon.png',
	backgroundColor : '#0055A6',
	width : '70%',
	height : '70%',
});
topView5.add(topImageView5);
