...
// Add to the parent view.
subnextview.add(Access_number_edit);

var groupcalling = Ti.UI.createLabel({
	text : 'Group',
	color : '#0054A5',
	font : {fontSize:tmp},
	//top : '36%',
