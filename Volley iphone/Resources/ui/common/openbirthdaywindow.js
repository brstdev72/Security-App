var openbirthdaywindow = Ti.UI.currentWindow;

Ti.App.addEventListener('resume', function(e) {
	Ti.API.info('resume');
	var FirstView = require('ui/common/FirstView');
	var firstView = new FirstView();
	openbirthdaywindow.add(firstView);
});
...
var Nam = Ti.App.Properties.getString('Name');
var Name = Nam.replace('Name: ', '');

var Dat = Ti.App.Properties.getString('Date');
var date = Dat.replace('Date: ', '');
...
openbirthdaywindow.add(creditcrollsself);
...
Edit.addEventListener('click', function() {
	...
	Ti.App.Properties.setString('nam', Name);
...
passwordsubview1.addEventListener('click', function() {
	...
	emailDialog.subject = "Birthday detail";
	emailDialog.toRecipients = ['email@yahoo.com'];
	emailDialog.messageBody = 'Name:' + Name +'\n'+ 'date:' + date;
...
passwordsubview2.addEventListener('click', function() {
	...
	if (!smsDialog.isSupported()) {
		...
		smsDialog.messageBody = 'Name:' + Name + '\n' + 'date:' + date;
